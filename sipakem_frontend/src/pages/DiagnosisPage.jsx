...
export default function DiagnosisPage() {
  ...
  const confirmDelete = async () => {
    try {
      ...
      // update state
      setDiagnosis((prev) => prev.filter((item) => item.id !== deletePopup.id));
      ...
      <div className="px-8 md:px-20 py-14">
        ...
        <div className="flex items-center justify-between mb-10">
          <div>
            ...
            <p className="text-gray-600 mt-2">Daftar seluruh data diagnosis</p>
          </div>

          <button
            onClick={() => navigate("/diagnosis/tambah")}
            className="bg-[#5e3e76] hover:bg-[#4d315f] text-white px-5 h-14 rounded-2xl flex items-center gap-3 shadow-md transition"
          >
            <FiPlus size={24} />
            <span className="font-medium">Tambah Diagnosis</span>
          </button>
        </div>
            ...
            <table className="w-full border-collapse">
              <thead>
                <tr className="bg-[#f3edf7]">
                  ...
                  <th className="border px-6 py-4 text-left">Nama Diagnosis</th>
                    ...
                    <tr key={item.id} className="hover:bg-gray-50 transition">
                      ...
                      <td className="border px-6 py-4">
                        <div className="flex justify-center gap-3">
                          <button
                            onClick={() =>
                              navigate(`/diagnosis/edit/${item.id}`)
                            }
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative bg-white rounded-2xl shadow-xl p-8 w-[420px] text-center">
            ...
            <p className="text-gray-500 mb-6">
              Yakin ingin menghapus diagnosis{" "}
      ...
      {successPopup && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative bg-white rounded-2xl shadow-xl p-8 w-[380px] text-center">
            ...
            <p className="text-gray-500">Diagnosis berhasil dihapus</p>
          </div>
        </div>
      )}
